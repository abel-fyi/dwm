...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_bar,   col_red   },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-p", "🚀 Run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_black, "-nf", col_gray3, "-sb", col_bar, "-sf", col_gray4, NULL };
static const char *emojicmd[] = { "/bin/sh", "-c",
	"curl -fsSL https://www.unicode.org/Public/emoji/latest/emoji-test.txt | "
